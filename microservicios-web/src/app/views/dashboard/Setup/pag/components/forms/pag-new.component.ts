  ...
  template: `
    ...
    <div>
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link active"><i class="{{ abcForms.btnNew.icon }}"></i> Nuevo Pago</a>
        </li>
      </ul>
...
export class PagNewComponent implements OnInit {
  abcForms: any;
  ...
  saveForm() {
    console.log(this.pagForm.value);
